namespace WindowsForms
{
    partial class PlanLista
    {
        ...
        private void InitializeComponent()
        {
            ...
            // planDataGridView
            // 
            planDataGridView.AllowUserToOrderColumns = true;
            planDataGridView.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            planDataGridView.Location = new Point(21, 18);
            planDataGridView.Margin = new Padding(2, 1, 2, 1);
            planDataGridView.MultiSelect = false;
            planDataGridView.Name = "planDataGridView";
            planDataGridView.ReadOnly = true;
            planDataGridView.RowHeadersWidth = 82;
            planDataGridView.RowTemplate.Height = 41;
            planDataGridView.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            planDataGridView.Size = new Size(751, 270);
            planDataGridView.TabIndex = 0;
            // 
            // agregarButton
            // 
